...
namespace Nac.Field.Citect {
	...
	public static class CtApi
	{
        ...
        public const int CT_LIST_VALUE = 0x00000001;    /* value						*/
        public const int CT_LIST_TIMESTAMP = 0x00000002;        /* timestamp					*/
        public const int CT_LIST_VALUE_TIMESTAMP = 0x00000003;      /* valueTimestamp				*/
        public const int CT_LIST_QUALITY_TIMESTAMP = 0x00000004;        /* qualityTimestamp				*/
        public const int CT_LIST_QUALITY_GENERAL = 0x00000005;      /* quality general				*/
        public const int CT_LIST_QUALITY_SUBSTATUS = 0x00000006;        /* quality substatus			*/
        public const int CT_LIST_QUALITY_LIMIT = 0x00000007;        /* quality limit				*/
        public const int CT_LIST_QUALITY_EXTENDED_SUBSTATUS = 0x00000008;       /* quality extended substatus	*/
        public const int CT_LIST_QUALITY_DATASOURCE_ERROR = 0x00000009;     /* quality datasource error		*/
        public const int CT_LIST_QUALITY_OVERRIDE = 0x0000000A;     /* quality override				*/
        public const int CT_LIST_QUALITY_CONTROL_MODE = 0x0000000B;		/* quality control mode			*/
        ...
        [DllImport("ctapi.dll", SetLastError = true)]
        public static extern uint ctListAddEx(
            uint hList,
            [MarshalAs(UnmanagedType.LPStr)] string sTag,
            bool bRaw,
            uint nPollPeriodMS,
        ...
        [DllImport("ctapi.dll", SetLastError = true)]
        public static extern bool ctListItem(
            uint hTag,
            int dwItem,
            [MarshalAs(UnmanagedType.LPStr)] System.Text.StringBuilder pBuffer,
            int dwLength,
            int dwMode);
