...
namespace Nac.Wpf.SectionEditor.NetworkModel
{
    ...
    /// </summary>
    public class NacWpfConnectorViewModel1 : AbstractModelBase
    {
        ...
        /// </summary>
        private ImpObservableCollection<NacWpfConnectionViewModel1> attachedConnections = null;
        ...
        public NacWpfConnectorViewModel1(string name)
        {
            Name = name;
            Type = NacWpfConnectorType.Undefined;
        }
        ...
        /// </summary>
        public NacWpfConnectorType Type
        {
            get;
            internal set;
        }
        ...
        /// The connections that are attached to this connector, or null if no connections are attached.
        /// </summary>
        public ImpObservableCollection<NacWpfConnectionViewModel1> AttachedConnections
        {
            get
            {
                if (attachedConnections == null)
                {
                    attachedConnections = new ImpObservableCollection<NacWpfConnectionViewModel1>();
        ...
        /// </summary>
        public NacWpfBlockViewModel1 ParentNode
        {
            get;
            internal set;
        }
