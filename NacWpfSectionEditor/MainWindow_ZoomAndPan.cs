...
using Nac.Wpf.SectionEditor.ZoomAndPan;
...
namespace Nac.Wpf.SectionEditor
{
    ...
    /// </summary>
    public partial class NacWpfSectionEditor1
    {
        /// <summary>
        ...
        {
            NacWpfBlockViewModel1 firstNode = (NacWpfBlockViewModel1)nodes[0];
            Rect actualContentRect = new Rect(firstNode.X, firstNode.Y, firstNode.Size.Width, firstNode.Size.Height);

            for (int i = 1; i < nodes.Count; ++i)
            {
                NacWpfBlockViewModel1 node = (NacWpfBlockViewModel1)nodes[i];
