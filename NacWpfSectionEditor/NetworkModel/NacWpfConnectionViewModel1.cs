...
namespace Nac.Wpf.SectionEditor.NetworkModel
{
    ...
    /// </summary>
    public sealed class NacWpfConnectionViewModel1 : AbstractModelBase
    {
        ...
        /// </summary>
        private NacWpfConnectorViewModel1 sourceConnector = null;

        /// <summary>
        /// The destination connector the connection is attached to.
        /// </summary>
        private NacWpfConnectorViewModel1 destConnector = null;
        ...
        /// The source connector the connection is attached to.
        /// </summary>
        public NacWpfConnectorViewModel1 SourceConnector
        {
            get
            {
        ...
        /// The destination connector the connection is attached to.
        /// </summary>
        public NacWpfConnectorViewModel1 DestConnector
        {
            get
            {
